...
helloworld-service-vertx   helloworld-service-vertx   rafabene/microservices-helloworld-vertx:1.0   app=helloworld-service-vertx,version=1.0   6          3h
...
mysql-rc-jn34r                   1/1       Running   0          13m
----
