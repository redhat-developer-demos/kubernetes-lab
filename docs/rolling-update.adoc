...
[vagrant@rhel-cdk kubernetes]$ *docker build -t rafabene/microservices-guestbook:2.0 .*
----
...
----
[vagrant@rhel-cdk frontend]$ *kubectl rolling-update frontend-ui frontend-ui-2 --image=rafabene/microservices-guestbook:2.0 --update-period=1s*
