...
mysql-rc                   mysql                      openshift/mysql-56-centos7                    app=mysql                                  1          2h
----
...
mysql-rc-xvi3c                   1/1       Running   0          1h
----
...
[source, bash, subs="normal,attributes"]
----
[vagrant@rhel-cdk kubernetes]$ *kubectl delete pod helloworld-service-vertx-prnhv*
pod "helloworld-service-vertx-prnhv" deleted
----
